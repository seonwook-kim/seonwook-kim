...
| ----------------------------------------------------------------- | --------- | ----------------------------------------------------------------------- |
| [CVE-2026-73433](https://www.cve.org/CVERecord?id=CVE-2026-73433) | GStreamer | AVI demuxer — out-of-bounds read/write via unsigned integer underflow   |
...
* Developed pipelines for **CVE feeds, public patches, and static-analysis results**
